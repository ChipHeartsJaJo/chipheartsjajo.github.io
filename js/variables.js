...
var mobileMenuTitle = "Menu", //The title of the mobile menu
  ...
  map_initial_latitude = 39.003394, //Google map initial Latitude. If "null", the latitude of the first marked will be used
  map_initial_longitude = -77.067272, //Google map initial Longitude. If "null", the longitude of the first marked will be used
